...
const Testimonial = () => {
  return (
    <div className='pb-14 px-8 md:px-0 w-auto max-w-7xl mx-auto text-center'>
      <h2 className='text-3xl font-medium text-gray-800'>Testimonials</h2>
      <p className='md:text-base text-gray-500 mt-3'>Hear our learners as they share their journeys of transformations. success and how our <br /> platform has made a difference in their lives</p>
