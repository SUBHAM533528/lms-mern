  ...
  return (
    <>
      <div className="md:px-36 px-8 pt-10">
        <h1 className="text-3xl font-semibold">My Enrollment</h1>
...
<button className="px-4 sm:px-5 py-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white cursor-pointer rounded" onClick={()=> Navigate(`/player/${course._id}`)}>
